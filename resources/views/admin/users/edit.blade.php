    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">会員情報の変更</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.users.update', [$user->id]) }}">
                        ...
                        <div class="form-group{{ $errors->has('name_kana') ? ' has-error' : '' }}">
                            <label for="name_kana" class="col-md-4 control-label">名前(カナ)</label>

                            <div class="col-md-6">
                                <input id="name_kana" type="text" class="form-control" name="name_kana" value="{{ old('name_kana', $user->name_kana) }}">
                        ...
                        <div class="form-group{{ $errors->has('postal_code') ? ' has-error' : '' }}">
                            <label for="postal_code" class="col-md-4 control-label">郵便番号(ハイフンなし)</label>

                            <div class="col-md-2">
                                <input id="postal_code" type="text" class="form-control" name="postal_code" value="{{ old('postal_code', $user->postal_code) }}" maxlength="7">
